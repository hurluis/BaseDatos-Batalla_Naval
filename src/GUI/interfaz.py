...
import sys
sys.path.append("src")
from LogicTTY.logica import Tablero
...
class GameScreen(Screen):
    def __init__(self, **kwargs):
        ...
        self.tablero_jugador.colocar_barcos(10)
    ...
    def disparo_jugador(self, instance):
        resultado_disparo = self.tablero_jugador.disparar(instance.fila, instance.columna)
